...
export const metadata: Metadata = {
  ...
  description: "Live Mumbai local train, metro, and BEST bus updates. Real-time delays, crowd info, and last train timings. Works offline.",
  keywords: [
    "Mumbai Local",
    "Mumbai Train",
    "Mumbai Metro",
  ...
  openGraph: {
    ...
    description: "Live Mumbai local train, metro, and BEST bus updates. Real-time delays, crowd info, and last train timings.",
    images: [
      {
        url: "/og-image.png",
        width: 1200,
