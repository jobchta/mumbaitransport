...
def run(playwright):
    ...
    try:
        ...
        page.screenshot(path="jules-scratch/verification/neo_v2_metro_modal.png")
        ...
        page.wait_for_selector(".modal-overlay.show")
        page.screenshot(path="jules-scratch/verification/neo_v2_fares_modal.png")
        page.click(".modal-close-btn")
        page.wait_for_selector(".modal-overlay:not(.show)")
        ...
        page.wait_for_selector(".modal-overlay.show")
        page.screenshot(path="jules-scratch/verification/neo_v2_plan_journey_modal.png")
        page.click(".modal-close-btn")
        page.wait_for_selector(".modal-overlay:not(.show)")
