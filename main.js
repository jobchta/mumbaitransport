...
(function() {
  ...
  class MumbaiTransportHub {
    ...
    initializeRoutes() {
      return {
        bus: [
          { id: 'A1', name: 'A-1 Express', from: 'Colaba', to: 'Bandra', time: 45, delay: 2, passengers: 65, capacity: 70 },
          { id: 'A2', name: 'A-2 Express', from: 'Colaba', to: 'Andheri', time: 60, delay: 3, passengers: 70, capacity: 70 },
          { id: 'A3', name: 'A-3 Express', from: 'Colaba', to: 'Borivali', time: 90, delay: 5, passengers: 60, capacity: 70 },
          { id: 'A4', name: 'A-4 Express', from: 'Colaba', to: 'Dahisar', time: 105, delay: 4, passengers: 55, capacity: 70 },
          { id: 'A5', name: 'A-5 Express', from: 'Colaba', to: 'Mira Road', time: 120, delay: 6, passengers: 50, capacity: 70 },
          { id: 'A6', name: 'A-6 Express', from: 'Colaba', to: 'Bhayandar', time: 135, delay: 5, passengers: 45, capacity: 70 },
          { id: 'A7', name: 'A-7 Express', from: 'Colaba', to: 'Vasai', time: 150, delay: 7, passengers: 40, capacity: 70 },
          { id: 'A8', name: 'A-8 Express', from: 'Colaba', to: 'Virar', time: 165, delay: 6, passengers: 35, capacity: 70 },
          { id: '1L', name: '1 Limited', from: 'Colaba', to: 'Bandra', time: 55, delay: 3, passengers: 68, capacity: 65 },
          { id: '2L', name: '2 Limited', from: 'Mumbai Central', to: 'Bandra', time: 50, delay: 2, passengers: 70, capacity: 65 },
          { id: '3L', name: '3 Limited', from: 'Colaba', to: 'Andheri', time: 70, delay: 4, passengers: 65, capacity: 65 },
          { id: '4L', name: '4 Limited', from: 'Colaba', to: 'Borivali', time: 100, delay: 6, passengers: 55, capacity: 65 },
          { id: '5L', name: '5 Limited', from: 'Colaba', to: 'Dahisar', time: 115, delay: 5, passengers: 50, capacity: 65 },
          { id: '6L', name: '6 Limited', from: 'Mumbai Central', to: 'Andheri', time: 60, delay: 3, passengers: 68, capacity: 65 },
          { id: '7L', name: '7 Limited', from: 'Mumbai Central', to: 'Borivali', time: 90, delay: 5, passengers: 58, capacity: 65 },
          { id: '8L', name: '8 Limited', from: 'Mumbai Central', to: 'Dahisar', time: 105, delay: 4, passengers: 53, capacity: 65 },
          { id: '1', name: 'Route 1', from: 'Colaba', to: 'Bandra', time: 65, delay: 4, passengers: 72, capacity: 60 },
          { id: '2', name: 'Route 2', from: 'Colaba', to: 'Andheri', time: 80, delay: 5, passengers: 68, capacity: 60 },
          { id: '3', name: 'Route 3', from: 'Colaba', to: 'Borivali', time: 110, delay: 7, passengers: 58, capacity: 60 },
          { id: '4', name: 'Route 4', from: 'Colaba', to: 'Dahisar', time: 125, delay: 6, passengers: 53, capacity: 60 },
          { id: '5', name: 'Route 5', from: 'Colaba', to: 'Mira Road', time: 140, delay: 8, passengers: 48, capacity: 60 },
          { id: '6', name: 'Route 6', from: 'Colaba', to: 'Bhayandar', time: 155, delay: 7, passengers: 43, capacity: 60 },
          { id: '7', name: 'Route 7', from: 'Colaba', to: 'Vasai', time: 170, delay: 9, passengers: 38, capacity: 60 },
          { id: '8', name: 'Route 8', from: 'Colaba', to: 'Virar', time: 185, delay: 8, passengers: 33, capacity: 60 },
          { id: '9', name: 'Route 9', from: 'Antop Hill', to: 'Colaba', time: 75, delay: 4, passengers: 62, capacity: 60 },
          { id: '10', name: 'Route 10', from: 'Colaba', to: 'Boisar', time: 200, delay: 10, passengers: 28, capacity: 60 },
          { id: '11', name: 'Route 11', from: 'Mumbai Central', to: 'Bandra', time: 50, delay: 3, passengers: 75, capacity: 60 },
          { id: '12', name: 'Route 12', from: 'Mumbai Central', to: 'Andheri', time: 65, delay: 4, passengers: 70, capacity: 60 },
          { id: '13', name: 'Route 13', from: 'Mumbai Central', to: 'Borivali', time: 95, delay: 6, passengers: 60, capacity: 60 },
          { id: '14', name: 'Route 14', from: 'Mumbai Central', to: 'Dahisar', time: 110, delay: 5, passengers: 55, capacity: 60 },
          { id: '15', name: 'Route 15', from: 'Mumbai Central', to: 'Mira Road', time: 125, delay: 7, passengers: 50, capacity: 60 },
          { id: '16', name: 'Route 16', from: 'Mumbai Central', to: 'Bhayandar', time: 140, delay: 6, passengers: 45, capacity: 60 },
          { id: '17', name: 'Route 17', from: 'Mumbai Central', to: 'Vasai', time: 155, delay: 8, passengers: 40, capacity: 60 },
          { id: '18', name: 'Route 18', from: 'Mumbai Central', to: 'Virar', time: 170, delay: 7, passengers: 35, capacity: 60 },
          { id: '19', name: 'Route 19', from: 'Mumbai Central', to: 'Nalasopara', time: 185, delay: 9, passengers: 30, capacity: 60 },
          { id: '20', name: 'Route 20', from: 'Mumbai Central', to: 'Boisar', time: 200, delay: 8, passengers: 25, capacity: 60 },
          { id: '21', name: 'Route 21', from: 'Bandra', to: 'Andheri', time: 35, delay: 2, passengers: 78, capacity: 60 },
          { id: '22', name: 'Route 22', from: 'Bandra', to: 'Borivali', time: 65, delay: 4, passengers: 68, capacity: 60 },
          { id: '23', name: 'Route 23', from: 'Bandra', to: 'Dahisar', time: 80, delay: 5, passengers: 63, capacity: 60 },
          { id: '24', name: 'Route 24', from: 'Bandra', to: 'Mira Road', time: 95, delay: 6, passengers: 58, capacity: 60 },
          { id: '25', name: 'Route 25', from: 'Bandra', to: 'Bhayandar', time: 110, delay: 5, passengers: 53, capacity: 60 },
          { id: '26', name: 'Route 26', from: 'Bandra', to: 'Vasai', time: 125, delay: 7, passengers: 48, capacity: 60 },
          { id: '27', name: 'Route 27', from: 'Bandra', to: 'Virar', time: 140, delay: 6, passengers: 43, capacity: 60 },
          { id: '28', name: 'Route 28', from: 'Bandra', to: 'Nalasopara', time: 155, delay: 8, passengers: 38, capacity: 60 },
          { id: '29', name: 'Route 29', from: 'Bandra', to: 'Boisar', time: 170, delay: 7, passengers: 33, capacity: 60 },
          { id: '30', name: 'Route 30', from: 'Bandra', to: 'Palghar', time: 185, delay: 9, passengers: 28, capacity: 60 },
          { id: '31', name: 'Route 31', from: 'Andheri', to: 'Borivali', time: 45, delay: 3, passengers: 80, capacity: 60 },
          { id: '32', name: 'Route 32', from: 'Andheri', to: 'Dahisar', time: 60, delay: 4, passengers: 75, capacity: 60 },
          { id: '33', name: 'Route 33', from: 'Andheri', to: 'Mira Road', time: 75, delay: 5, passengers: 70, capacity: 60 },
          { id: '34', name: 'Route 34', from: 'Andheri', to: 'Bhayandar', time: 90, delay: 4, passengers: 65, capacity: 60 },
          { id: '35', name: 'Route 35', from: 'Andheri', to: 'Vasai', time: 105, delay: 6, passengers: 60, capacity: 60 },
          { id: '36', name: 'Route 36', from: 'Andheri', to: 'Virar', time: 120, delay: 5, passengers: 55, capacity: 60 },
          { id: '37', name: 'Route 37', from: 'Santacruz', to: 'Colaba', time: 85, delay: 5, passengers: 55, capacity: 60 },
          { id: '38', name: 'Route 38', from: 'Santacruz', to: 'Mumbai Central', time: 60, delay: 3, passengers: 65, capacity: 60 },
          { id: '39', name: 'Route 39', from: 'Santacruz', to: 'Bandra', time: 35, delay: 2, passengers: 75, capacity: 60 },
          { id: '40', name: 'Route 40', from: 'Santacruz', to: 'Andheri', time: 50, delay: 3, passengers: 70, capacity: 60 },
          { id: '41', name: 'Route 41', from: 'Borivali', to: 'Dahisar', time: 25, delay: 1, passengers: 85, capacity: 60 },
          { id: '42', name: 'Route 42', from: 'Sandhurst Road', to: 'Kamla Nehru Park', time: 45, delay: 3, passengers: 62, capacity: 60 },
          { id: '43', name: 'Route 43', from: 'Borivali', to: 'Mira Road', time: 40, delay: 2, passengers: 80, capacity: 60 },
          { id: '44', name: 'Route 44', from: 'Borivali', to: 'Bhayandar', time: 55, delay: 3, passengers: 75, capacity: 60 },
          { id: '45', name: 'Route 45', from: 'Borivali', to: 'Vasai', time: 70, delay: 4, passengers: 70, capacity: 60 },
          { id: '46', name: 'Route 46', from: 'Borivali', to: 'Virar', time: 85, delay: 5, passengers: 65, capacity: 60 },
          { id: '47', name: 'Route 47', from: 'Borivali', to: 'Nalasopara', time: 100, delay: 4, passengers: 60, capacity: 60 },
          { id: '48', name: 'Route 48', from: 'Borivali', to: 'Boisar', time: 115, delay: 6, passengers: 55, capacity: 60 },
          { id: '49', name: 'Route 49', from: 'Borivali', to: 'Palghar', time: 130, delay: 5, passengers: 50, capacity: 60 },
          { id: '50', name: 'Route 50', from: 'Borivali', to: 'Dahanu', time: 155, delay: 7, passengers: 45, capacity: 60 },
          { id: '51', name: 'Route 51', from: 'Kurla', to: 'Colaba', time: 70, delay: 4, passengers: 65, capacity: 60 },
          { id: '52', name: 'Route 52', from: 'Kurla', to: 'Mumbai Central', time: 50, delay: 3, passengers: 72, capacity: 60 },
          { id: '53', name: 'Route 53', from: 'Kurla', to: 'Bandra', time: 60, delay: 4, passengers: 68, capacity: 60 },
          { id: '54L', name: 'Route 54 Limited', from: 'Kurla', to: 'Colaba', time: 55, delay: 3, passengers: 58, capacity: 55 },
          { id: '55', name: 'Route 55', from: 'Kurla', to: 'Andheri', time: 45, delay: 2, passengers: 75, capacity: 60 },
          { id: '56', name: 'Route 56', from: 'Kurla', to: 'Borivali', time: 75, delay: 5, passengers: 65, capacity: 60 },
          { id: '57', name: 'Route 57', from: 'Kurla', to: 'Dahisar', time: 90, delay: 6, passengers: 60, capacity: 60 },
          { id: '58', name: 'Route 58', from: 'Kurla', to: 'Mira Road', time: 105, delay: 5, passengers: 55, capacity: 60 },
          { id: '59', name: 'Route 59', from: 'Kurla', to: 'Bhayandar', time: 120, delay: 7, passengers: 50, capacity: 60 },
          { id: '60', name: 'Route 60', from: 'Kurla', to: 'Vasai', time: 135, delay: 6, passengers: 45, capacity: 60 },
          { id: '61', name: 'Route 61', from: 'Thane', to: 'Colaba', time: 100, delay: 7, passengers: 50, capacity: 60 },
          { id: '62', name: 'Route 62', from: 'Thane', to: 'Mumbai Central', time: 80, delay: 5, passengers: 60, capacity: 60 },
          { id: '63', name: 'Route 63', from: 'Thane', to: 'Bandra', time: 90, delay: 6, passengers: 55, capacity: 60 },
          { id: '64', name: 'Route 64', from: 'Thane', to: 'Andheri', time: 70, delay: 4, passengers: 65, capacity: 60 },
          { id: '65', name: 'Route 65', from: 'Thane', to: 'Borivali', time: 85, delay: 5, passengers: 60, capacity: 60 },
          { id: '66', name: 'Route 66', from: 'Thane', to: 'Dahisar', time: 100, delay: 6, passengers: 55, capacity: 60 },
          { id: '67', name: 'Route 67', from: 'Thane', to: 'Mira Road', time: 115, delay: 5, passengers: 50, capacity: 60 },
          { id: '68', name: 'Route 68', from: 'Thane', to: 'Bhayandar', time: 130, delay: 7, passengers: 45, capacity: 60 },
          { id: '69', name: 'Route 69', from: 'Thane', to: 'Vasai', time: 145, delay: 6, passengers: 40, capacity: 60 },
          { id: '70', name: 'Route 70', from: 'Thane', to: 'Virar', time: 160, delay: 8, passengers: 35, capacity: 60 },
          { id: '101', name: 'Route 101', from: 'Worli', to: 'Bandra', time: 40, delay: 2, passengers: 70, capacity: 60 },
          { id: '102', name: 'Route 102', from: 'Worli', to: 'Andheri', time: 55, delay: 3, passengers: 65, capacity: 60 },
          { id: '103', name: 'Route 103', from: 'Worli', to: 'Borivali', time: 85, delay: 5, passengers: 55, capacity: 60 },
          { id: '104', name: 'Route 104', from: 'Worli', to: 'Dahisar', time: 100, delay: 4, passengers: 50, capacity: 60 },
          { id: '105', name: 'Route 105', from: 'Worli', to: 'Mira Road', time: 115, delay: 6, passengers: 45, capacity: 60 },
          { id: '106', name: 'Route 106', from: 'Worli', to: 'Bhayandar', time: 130, delay: 5, passengers: 40, capacity: 60 },
          { id: '107', name: 'Route 107', from: 'Worli', to: 'Vasai', time: 145, delay: 7, passengers: 35, capacity: 60 },
          { id: '108', name: 'Route 108', from: 'Worli', to: 'Virar', time: 160, delay: 6, passengers: 30, capacity: 60 },
          { id: '109', name: 'Route 109', from: 'Worli', to: 'Nalasopara', time: 175, delay: 8, passengers: 25, capacity: 60 },
          { id: '110', name: 'Route 110', from: 'Worli', to: 'Boisar', time: 190, delay: 7, passengers: 20, capacity: 60 },
          { id: '201', name: 'Route 201', from: 'Airport', to: 'Colaba', time: 90, delay: 5, passengers: 45, capacity: 60 },
          { id: '202', name: 'Route 202', from: 'Airport', to: 'Mumbai Central', time: 70, delay: 4, passengers: 55, capacity: 60 },
          { id: '203', name: 'Route 203', from: 'Airport', to: 'Bandra', time: 50, delay: 3, passengers: 65, capacity: 60 },
          { id: '204', name: 'Route 204', from: 'Airport', to: 'Andheri', time: 30, delay: 2, passengers: 75, capacity: 60 },
          { id: '205', name: 'Route 205', from: 'Airport', to: 'Borivali', time: 60, delay: 4, passengers: 60, capacity: 60 },
          { id: '206', name: 'Route 206', from: 'Airport', to: 'Dahisar', time: 75, delay: 5, passengers: 55, capacity: 60 },
          { id: '207', name: 'Route 207', from: 'Airport', to: 'Mira Road', time: 90, delay: 6, passengers: 50, capacity: 60 },
          { id: '208', name: 'Route 208', from: 'Airport', to: 'Bhayandar', time: 105, delay: 5, passengers: 45, capacity: 60 },
          { id: '209', name: 'Route 209', from: 'Airport', to: 'Vasai', time: 120, delay: 7, passengers: 40, capacity: 60 },
          { id: '210', name: 'Route 210', from: 'Airport', to: 'Virar', time: 135, delay: 6, passengers: 35, capacity: 60 },
          { id: 'N1', name: 'Night Route N1', from: 'Colaba', to: 'Bandra', time: 50, delay: 3, passengers: 30, capacity: 60 },
          { id: 'N2', name: 'Night Route N2', from: 'Colaba', to: 'Andheri', time: 65, delay: 4, passengers: 25, capacity: 60 },
          { id: 'N3', name: 'Night Route N3', from: 'Colaba', to: 'Borivali', time: 95, delay: 6, passengers: 20, capacity: 60 },
          { id: 'N4', name: 'Night Route N4', from: 'Mumbai Central', to: 'Bandra', time: 45, delay: 2, passengers: 35, capacity: 60 },
          { id: 'N5', name: 'Night Route N5', from: 'Mumbai Central', to: 'Andheri', time: 60, delay: 3, passengers: 30, capacity: 60 },
          { id: 'N6', name: 'Night Route N6', from: 'Mumbai Central', to: 'Borivali', time: 90, delay: 5, passengers: 25, capacity: 60 },
          { id: 'N7', name: 'Night Route N7', from: 'Bandra', to: 'Andheri', time: 30, delay: 2, passengers: 40, capacity: 60 },
          { id: 'N8', name: 'Night Route N8', from: 'Bandra', to: 'Borivali', time: 60, delay: 4, passengers: 30, capacity: 60 },
          { id: 'N9', name: 'Night Route N9', from: 'Andheri', to: 'Borivali', time: 40, delay: 3, passengers: 35, capacity: 60 },
          { id: 'N10', name: 'Night Route N10', from: 'Borivali', to: 'Dahisar', time: 20, delay: 1, passengers: 45, capacity: 60 },
          { id: 'AC1', name: 'AC Route 1', from: 'Colaba', to: 'Bandra', time: 45, delay: 2, passengers: 55, capacity: 50 },
          { id: 'AC2', name: 'AC Route 2', from: 'Colaba', to: 'Andheri', time: 60, delay: 3, passengers: 50, capacity: 50 },
          { id: 'AC3', name: 'AC Route 3', from: 'Colaba', to: 'Borivali', time: 90, delay: 5, passengers: 40, capacity: 50 },
          { id: 'AC4', name: 'AC Route 4', from: 'Mumbai Central', to: 'Bandra', time: 40, delay: 2, passengers: 60, capacity: 50 },
          { id: 'AC5', name: 'AC Route 5', from: 'Mumbai Central', to: 'Andheri', time: 55, delay: 3, passengers: 55, capacity: 50 },
          { id: 'AC6', name: 'AC Route 6', from: 'Mumbai Central', to: 'Borivali', time: 85, delay: 5, passengers: 45, capacity: 50 },
          { id: 'AC7', name: 'AC Route 7', from: 'Bandra', to: 'Andheri', time: 30, delay: 2, passengers: 65, capacity: 50 },
          { id: 'AC8', name: 'AC Route 8', from: 'Bandra', to: 'Borivali', time: 60, delay: 4, passengers: 55, capacity: 50 },
          { id: 'AC9', name: 'AC Route 9', from: 'Andheri', to: 'Borivali', time: 40, delay: 3, passengers: 60, capacity: 50 },
          { id: 'AC10', name: 'AC Route 10', from: 'Borivali', to: 'Dahisar', time: 20, delay: 1, passengers: 70, capacity: 50 },
          { id: '242', name: 'Route 242', from: 'Bandra Station', to: 'Worli', time: 35, delay: 2, passengers: 65, capacity: 65 }
        ],
        train: [
...
(function(){
  ...
  if (!tryInit()) {
    ...
    setTimeout(() => clearInterval(iv), 12000);
      ...
      class LocationAwareSystem {
        constructor() {
          this.userLocation = null;
          this.nearbyRoutes = [];
          this.favoriteRoutes = JSON.parse(localStorage.getItem('favoriteRoutes') || '[]');
        ...
        // Find routes near user's location
        findNearbyRoutes() {
          if (!this.userLocation) return;

          const allRoutes = this.getAllRoutes();
          this.nearbyRoutes = allRoutes.filter(route => {
            // Simple distance calculation (in real app, use proper geocoding)
            const routeDistance = this.calculateDistance(route);
            return routeDistance < 5; // Within 5km
          });

          console.log('🚌 Found', this.nearbyRoutes.length, 'nearby routes');
          this.updateNearbyRoutesDisplay();
        }

        // Calculate distance to route (simplified)
        calculateDistance(route) {
          // This would use actual route coordinates in a real implementation
          const routeCoords = this.getRouteCoordinates(route);
          if (!routeCoords) return 999;

          const latDiff = this.userLocation.lat - routeCoords.lat;
          const lngDiff = this.userLocation.lng - routeCoords.lng;
          return Math.sqrt(latDiff * latDiff + lngDiff * lngDiff) * 111; // Rough km conversion
        }

        // Get route coordinates (mock data)
        getRouteCoordinates(route) {
          const routeCoords = {
            '1': { lat: 18.9100, lng: 72.8090 }, // Colaba
            '11': { lat: 18.9700, lng: 72.8200 }, // Mumbai Central
            '21': { lat: 19.0600, lng: 72.8300 }, // Bandra
            '31': { lat: 19.1200, lng: 72.8400 }, // Andheri
            '41': { lat: 19.2300, lng: 72.8500 }, // Borivali
            '242': { lat: 19.0600, lng: 72.8300 }, // Bandra Station
          };
          return routeCoords[route.id] || null;
        }

        // Get all available routes
        getAllRoutes() {
          const routes = [];
          // Extract routes from the existing data
          const routeData = window.MumbaiTransport?.appData?.routes?.bus || [];
        ...
        // Update display with nearby routes
        updateNearbyRoutesDisplay() {
          const nearbySection = document.getElementById('nearby-routes-section');
          if (!nearbySection) return;

          if (this.nearbyRoutes.length === 0) {
            nearbySection.innerHTML = '<p>No routes found nearby. Try enabling location access.</p>';
            return;
          }

          let html = '<div class="nearby-routes-grid">';
          this.nearbyRoutes.slice(0, 6).forEach(route => {
            html += `
              <div class="nearby-route-card">
                <div class="route-header">
                  <span class="route-number">${route.id}</span>
                  <span class="route-name">${route.name}</span>
                </div>
                <div class="route-details">
                  <div class="route-route">${route.from} → ${route.to}</div>
                  <div class="route-time">${route.time} min • ${route.delay} min delay</div>
                </div>
                <div class="route-status">
                  <span class="status-indicator ${route.delay > 2 ? 'status-delayed' : 'status-active'}"></span>
                  <span>${route.passengers}/${route.capacity} passengers</span>
                </div>
              </div>
            `;
          });
        ...
        addToFavorites(routeId) {
          if (!this.favoriteRoutes.includes(routeId)) {
            ...
            console.log('⭐ Added route', routeId, 'to favorites');
          }
        }
        ...
        getTimeBasedRecommendations() {
          ...
          if (hour >= 7 && hour <= 10) {
            // Morning rush hour
            recommendations = this.getAllRoutes().filter(route =>
              route.from.includes('Bandra') || route.from.includes('Andheri') || route.from.includes('Borivali')
            );
          } else if (hour >= 17 && hour <= 20) {
            // Evening rush hour
            recommendations = this.getAllRoutes().filter(route =>
              route.to.includes('Bandra') || route.to.includes('Andheri') || route.to.includes('Borivali')
            );
          } else {
            // Off-peak
            recommendations = this.getAllRoutes().slice(0, 10);
          }
        ...
        init() {
          console.log('📍 Initializing location-aware system...');
          this.getUserLocation();
          this.updateTimeBasedRecommendations();
        ...
        // Update time-based recommendations display
        updateTimeBasedRecommendations() {
          const recommendations = this.getTimeBasedRecommendations();
          const recSection = document.getElementById('time-recommendations-section');
          if (!recSection) return;

          const hour = new Date().getHours();
          let timeLabel = 'Recommended Routes';
          if (hour >= 7 && hour <= 10) timeLabel = '🌅 Morning Rush Hour Routes';
          else if (hour >= 17 && hour <= 20) timeLabel = '🌆 Evening Rush Hour Routes';
          else timeLabel = '⏰ Off-Peak Routes';

          let html = `<h3>${timeLabel}</h3><div class="recommendations-grid">`;
          recommendations.forEach(route => {
            html += `
              <div class="recommendation-card">
                <div class="rec-route-number">${route.id}</div>
                <div class="rec-route-details">
                  <div class="rec-route-name">${route.name}</div>
                  <div class="rec-route-route">${route.from} → ${route.to}</div>
                </div>
                <button class="rec-favorite-btn" onclick="locationSystem.addToFavorites('${route.id}')">⭐</button>
              </div>
            `;
          });
          html += '</div>';
      ...
      document.addEventListener('DOMContentLoaded', function() {
        locationSystem = new LocationAwareSystem();
        locationSystem.init();
      });
      ...
      function updateRouteCount() {
        ...
        if (busCountElement) {
          busCountElement.textContent = routeStats.totalRoutes;
        }
        console.log('🚌 Total BEST routes available:', routeStats.totalRoutes);
      }
      ...
      class RealTimeTrackingSystem {
        ...
        updateBusPositions() {
          const routes = window.MumbaiTransport?.appData?.routes?.bus || [];
          routes.forEach(route => {
